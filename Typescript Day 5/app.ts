...
document.getElementById("loginForm")?.addEventListener("submit", function (e) {
  ...
  if (foundUser) {
    (document.getElementById("loginForm") as HTMLElement).style.display = "none";     // Hiding login form
...
function resetView() {
  ...
  (document.getElementById("salaryInfo") as HTMLElement).style.display = "none"; // Hiding salary
